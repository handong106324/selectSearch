	...
	$.extend(Plugin.prototype, {
		...
		_construct: function(){
			...
			this.$options.each(function(i, e){
				...
				var cls = (this.disabled? self.settings.disabledClass : "option-item");

				var hid = $(this).attr("hidden");
				if (hid != 'hidden')
				{
					o+='<li class="'+cls + ' ' +(k == self.selectedIndex? self.settings.selectedClass : '')+ '" data-index="'+(k)+'" data-value="'+this.value+'">'+ (this.innerHTML) + '</li>'
				}
		...
		_filter: function(search){
			...
			if(needle){
				...
				this.$items.filter('.option-group, .option-hidden').hide();
